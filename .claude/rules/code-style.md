...
See [.claude/rules/python-style.md](.claude/rules/python-style.md) for comprehensive Python style guide.

**Quick Reference:**
- **PEP 8 compliance** - Follow Python style guide
- **Type hints required** - All function signatures must have type annotations
- **Black formatter** - 88 character line length
- **Ruff linter** - Fast Python linter (replaces Flake8, isort)
